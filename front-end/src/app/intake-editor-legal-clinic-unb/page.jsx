...
//     );
//   };
//   const SortableField = ({ field, fieldIndex, stepIndex, children }) => {
//     const {
//       attributes,
//       listeners,
//       setNodeRef,
...
//     );
//   };
//   // SortableStep component for drag and drop functionality
...
//       setActiveField(active.data.current);
//     }
//   };
...
//             const [sourceStepIndex, sourceFieldIndex] = active.id.split('-field-').map(Number);
//             const [targetStepIndex, targetFieldIndex] = over.id.split('-field-').map(Number);
...
//               const fields = [...sourceStep.fields];
//               const [movedField] = fields.splice(sourceFieldIndex, 1);
//               fields.splice(targetFieldIndex, 0, movedField);
//               newSteps[sourceStepIndex] = { ...sourceStep, fields };
//             } else {
...
//                 >
//                   {formData.steps.map((step, stepIndex) => (
//                     <SortableStep key={step.id} step={step} stepIndex={stepIndex}>
//                       <div className="flex items-center justify-between mb-4">
//                         <div className="flex items-center gap-4">
//                           {ICONS[step.icon] && React.createElement(ICONS[step.icon], {
//                             size: 20,
...
//               <DragOverlay>
//                 {activeId ? (
//                   <Card className="mb-4 border-2 border-blue-500 opacity-50">
//                     <CardContent className="p-6">
//                       <div className="flex items-center justify-between mb-4">
//                         <div className="flex items-center gap-4">
//                           {ICONS[formData.steps.find(step => step.id === activeId)?.icon] && 
//                             React.createElement(ICONS[formData.steps.find(step => step.id === activeId)?.icon], {
//                               size: 20,
//                               className: "text-blue-500"
//                             })}
//                           <span className="font-semibold">
//                             {formData.steps.find(step => step.id === activeId)?.title}
//                           </span>
//                         </div>
//                       </div>
//                     </CardContent>
