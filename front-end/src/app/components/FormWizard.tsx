...
//   const { formConfig, RESOURCES } = configData;
...
//     // Update active resources if we have any
  ...
  const FileUploadSection = () => (
    <div className="mt-8 p-6 border border-dashed border-gray-300 rounded-lg bg-gray-50">
      <div className="flex flex-col items-center">
        ...
        <h4 className="font-medium text-gray-900 mb-2">Upload Supporting Documents</h4>
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 
            rounded-lg hover:bg-blue-100 border border-blue-200"
        >
          Browse Files
        </button>
        <input
      ...
      {selectedFiles.length > 0 && (
        <div className="mt-6">
          <h5 className="font-medium text-gray-700 mb-3">Selected Files ({selectedFiles.length})</h5>
